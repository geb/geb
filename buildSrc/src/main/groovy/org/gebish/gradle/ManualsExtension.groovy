...
class ManualsExtension {
    ...
    private static final String GATHER_MANUALS_TASK = "gatherManuals"
    ...
    void include(String... versions) {
        includedManuals.addAll(versions)
        project.tasks.named(GATHER_MANUALS_TASK, GatherManuals).configure {
            versions.each { version ->
                gatherPublishedManual(version)
            }
        }
    }
}
