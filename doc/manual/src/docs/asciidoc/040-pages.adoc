...
[source,groovy]
----
include::{test-dir}/pages/TemplateOptionsSpec.groovy[tag=wait_condition_page,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/pages/TemplateOptionsSpec.groovy[tag=wait_condition_page_content_access,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/pages/ContentNamesSpec.groovy[tag=page,indent=0]
----

[source,groovy]
----
include::{test-dir}/pages/ContentNamesSpec.groovy[tag=usage,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/pages/UnexpectedPagesSpec.groovy[tag=unexpected_page_with_custom_message,indent=0]

include::{test-dir}/pages/UnexpectedPagesSpec.groovy[tag=usage_with_custom_message,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/pages/PageEventListenerSpec.groovy[tag=config,indent=0]
----
