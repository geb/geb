...
[source,groovy]
----
include::{test-dir}/assertions/ImplicitAssertionsSpec.groovy[tag=at_checking_with_assertions,indent=0]
----

…you might see an error similar to…
[source,groovy]
----
include::{test-dir}/assertions/ImplicitAssertionsSpec.groovy[tag=at_checking_with_assertions_message,indent=0]
----
...
----
include::{test-dir}/assertions/ImplicitAssertionsSpec.groovy[tag=disable_implicit_assertions,indent=0]
----
