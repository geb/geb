...
[source,html]
----
include::{test-dir}/javascript/CallingMethodsSpec.groovy[tag=html,indent=0]
----
...
To call _nested_ methods, we use the same syntax as for properties…
...
[source,html]
----
include::{real-browser-test-dir}/javascript/AlertSpec.groovy[tag=alert_html,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/javascript/AlertSpec.groovy[tag=alert,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/javascript/AlertSpec.groovy[tag=async_alert,indent=0]
----
...
[NOTE]
====
If you don't use `withAlert()` to handle an alert that is raised and continue to drive the browser then `{unhandled-alert-exception-api}` will be raised.
====

=== `confirm()`

There are four methods that deal with `confirm()` dialogs:
...
[source,html]
----
include::{real-browser-test-dir}/javascript/ConfirmSpec.groovy[tag=confirm_html,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/javascript/ConfirmSpec.groovy[tag=confirm,indent=0]
----
...
[NOTE]
====
If you don't use `withConfirm()` to handle a confirmation that is raised and continue to drive the browser then `{unhandled-alert-exception-api}` will be raised.
====
