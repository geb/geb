...
[source,groovy]
----
include::{test-dir}/navigator/DynamicNavigatorSpec.groovy[tag=example,indent=0]
----
...
[source,html]
----
include::{real-browser-test-dir}/navigator/DynamicModuleBaseSpec.groovy[tag=template,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/navigator/DynamicModuleBaseSpec.groovy[tag=vue_app,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/navigator/DynamicModuleBaseSpec.groovy[tag=module,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/navigator/DynamicModuleBaseSpec.groovy[tag=static_navigator,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/navigator/DynamicModuleBaseSpec.groovy[tag=exception,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/navigator/DynamicModuleBaseSpec.groovy[tag=dynamic_navigator,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/navigator/DynamicModuleBaseSpec.groovy[tag=no_exception,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/navigator/NavigatorEventListenerSpec.groovy[tag=config,indent=0]
----
...
[source,html]
----
include::{test-dir}/navigator/FocusSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/navigator/FocusSpec.groovy[tag=focus,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/navigator/CheckboxSpec.groovy[tag=multiple_single_choice,indent=0]
----
...
You can track this issue link:http://code.google.com/p/selenium/issues/detail?id=2131[here].
====
...
[source,groovy]
----
include::{real-browser-test-dir}/navigator/InteractionsSpec.groovy[tag=actions_in_interact,indent=0]
----
