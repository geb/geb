...
[source,groovy]
----
include::{real-browser-test-dir}/intro/ScriptingSpec.groovy[tags=imports,indent=0]

include::{real-browser-test-dir}/intro/ScriptingSpec.groovy[tags=inline,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/intro/module/ManualsMenuModule.groovy[tags=imports,indent=0]
include::{real-browser-test-dir}/intro/page/GebHomePage.groovy[tags=imports,indent=0]

include::{real-browser-test-dir}/intro/module/ManualsMenuModule.groovy[tags=class,indent=0]

include::{real-browser-test-dir}/intro/page/GebHomePage.groovy[tags=class,indent=0]

include::{real-browser-test-dir}/intro/page/TheBookOfGebPage.groovy[tags=class,indent=0]
----
...
include::{real-browser-test-dir}/intro/ScriptingSpec.groovy[tags=using_page_objects,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/intro/GebHomepageSpec.groovy[tags=imports,indent=0]

include::{real-browser-test-dir}/intro/GebHomepageSpec.groovy[tags=class,indent=0]
----
