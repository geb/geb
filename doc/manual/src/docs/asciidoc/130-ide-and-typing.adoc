...
Ensure that you familiarise yourself with the <<intellij-support, section on what that support entails>> if you are an user of IntelliJ Idea.
====
...
[source,groovy]
----
include::{test-dir}/ide/StrongTypingSpec.groovy[tag=at,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/intellij/StrongTypingSpec.groovy[tag=typed,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/intellij/StrongTypingSpec.groovy[tag=pages,indent=0]
----
