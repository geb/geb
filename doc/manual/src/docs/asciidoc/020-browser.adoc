...
[WARNING]
====
This mechanism has been deprecated and will be removed in the next major version of Geb. Please use a <<listening-to-page-events,`PageEventListener`>> instead.
====
...
`link:api/geb/Browser.html#withWindow(java.lang.String,%20Closure%3CT%3E)["withWindow(String windowName, Closure block)"]`.
...
`link:api/geb/Browser.html#withWindow(groovy.lang.Closure,%20Closure%3CT%3E)["withWindow(Closure specification, Closure block)"]` method.
...
There are some additional options that can be passed to a link:api/geb/Browser.html#withWindow(java.util.Map,%20groovy.lang.Closure,%20Closure%3CT%3E)[`withWindow()`] call which make working
...
`link:api/geb/Browser.html#withNewWindow(groovy.lang.Closure,%20Closure%3CT%3E)["withNewWindow(Closure windowOpeningBlock, Closure block)"]` method.
Given that this HTML is rendered for the `baseUrl`:
...
There are several options that can be passed to a link:api/geb/Browser.html#withNewWindow(java.util.Map,%20groovy.lang.Closure,%20Closure%3CT%3E)[`withNewWindow()`] call which make working
...
[source,groovy,indent=0]
----
include::{real-browser-test-dir}/browser/WebStorageSpec.groovy[tag=write_and_read]
----
