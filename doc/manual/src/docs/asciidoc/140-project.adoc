...
* gihtub-profile:JacobAae[Jacob Aae Mikkelsen] - Various fixes and improvements
...
* Migrated continuous integration build to link:https://app.snap-ci.com/geb/geb/branch/master[Snap CI]
