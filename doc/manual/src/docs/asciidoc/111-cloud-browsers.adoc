...
<11> Pass additional link:https://docs.saucelabs.com/dev/cli/sauce-connect-proxy#sauce-connect-proxy-command-line-options[command line options] to SauceConnect.
...
lambdaTest {
    ...
    browsers { //<4>
        chrome_windows_70 {
           capabilities platformName: "Windows 10" //<5>
        }
    }
    task { //<6>
       maxHeapSize = "512m"
