...
If you are using a build tool such as http://gradle.org/[Gradle] or http://maven.apache.org/[Maven] that has the concept of test “resources”, then that directory is a suitable place.
