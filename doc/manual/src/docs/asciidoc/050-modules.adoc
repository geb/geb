...
[source,html]
----
include::{snippets-dir}/modules/DateInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{snippets-dir}/modules/DateInputSnippetSpec.groovy[tag=example,indent=0]
----
...
[source,html]
----
include::{snippets-dir}/modules/DateTimeLocalInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{snippets-dir}/modules/DateTimeLocalInputSnippetSpec.groovy[tag=example,indent=0]
----
...
[source,html]
----
include::{snippets-dir}/modules/TimeInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{snippets-dir}/modules/TimeInputSnippetSpec.groovy[tag=example_time,indent=0]
----
...
[source,groovy]
----
include::{snippets-dir}/modules/TimeInputSnippetSpec.groovy[tag=example_string,indent=0]
----
...
[source,html]
----
include::{snippets-dir}/modules/MonthInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{snippets-dir}/modules/MonthInputSnippetSpec.groovy[tag=example_month,indent=0]
----
...
[source,groovy]
----
include::{snippets-dir}/modules/MonthInputSnippetSpec.groovy[tag=example_string,indent=0]
----
...
[source,html]
----
include::{snippets-dir}/modules/WeekInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{snippets-dir}/modules/WeekInputSnippetSpec.groovy[tag=example_week,indent=0]
----
...
[source,groovy]
----
include::{snippets-dir}/modules/WeekInputSnippetSpec.groovy[tag=example_string,indent=0]
----
...
[source,html]
----
include::{snippets-dir}/modules/RangeInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{snippets-dir}/modules/RangeInputSnippetSpec.groovy[tag=example,indent=0]
----
