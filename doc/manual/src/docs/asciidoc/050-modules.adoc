...
To be able to return a list of different instances it's needs a closure which acts as a factory of module instances.
====
...
[source,html]
----
include::{test-dir}/modules/SearchInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/modules/SearchInputSnippetSpec.groovy[tag=example,indent=0]
----
...
[source,html]
----
include::{real-browser-test-dir}/modules/DateInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/modules/DateInputSnippetSpec.groovy[tag=example,indent=0]
----
...
[source,html]
----
include::{real-browser-test-dir}/modules/DateTimeLocalInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/modules/DateTimeLocalInputSnippetSpec.groovy[tag=example,indent=0]
----
...
[source,html]
----
include::{real-browser-test-dir}/modules/TimeInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/modules/TimeInputSnippetSpec.groovy[tag=example_time,indent=0]
----
...
[source,html]
----
include::{real-browser-test-dir}/modules/MonthInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/modules/MonthInputSnippetSpec.groovy[tag=example_month,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/modules/MonthInputSnippetSpec.groovy[tag=example_string,indent=0]
----
...
[source,html]
----
include::{test-dir}/modules/EmailInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/modules/EmailInputSnippetSpec.groovy[tag=example,indent=0]
----
...
[source,html]
----
include::{test-dir}/modules/TelInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/modules/TelInputSnippetSpec.groovy[tag=example,indent=0]
----
...
[source,html]
----
include::{test-dir}/modules/NumberInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/modules/NumberInputSnippetSpec.groovy[tag=example,indent=0]
----

=== `RangeInput`

The `{range-input-api}` module provides property methods for setting and retrieving the current number value of a number input element. It also provides methods to retrieve the values of its `min`, `max` and `step` attributes.

Given the html…

[source,html]
----
include::{real-browser-test-dir}/modules/RangeInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{real-browser-test-dir}/modules/RangeInputSnippetSpec.groovy[tag=example,indent=0]
----
...
[source,html]
----
include::{test-dir}/modules/UrlInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/modules/UrlInputSnippetSpec.groovy[tag=example,indent=0]
----
...
[source,html]
----
include::{test-dir}/modules/PasswordInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/modules/PasswordInputSnippetSpec.groovy[tag=example,indent=0]
----
...
[source,html]
----
include::{test-dir}/modules/ColorInputSnippetSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/modules/ColorInputSnippetSpec.groovy[tag=example_color,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/modules/ColorInputSnippetSpec.groovy[tag=example_string,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/modules/UnwrappingModulesSnippetSpec.groovy[tag=page,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/modules/UnwrappingModulesSnippetSpec.groovy[tag=module,indent=0]
----
...
[source,groovy]
----
include::{test-dir}/modules/UnwrappingModulesSnippetSpec.groovy[tag=module_argument_fail_method,indent=0]
