...
[source,groovy]
----
include::{testDir}/driver/HtmlUnitRefreshHandlerSpec.groovy[tag=import,indent=0]

include::{testDir}/driver/HtmlUnitRefreshHandlerSpec.groovy[tag=changing_handler,indent=0]
----
