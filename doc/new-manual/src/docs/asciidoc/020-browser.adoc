...
[source,groovy,indent=0]
----
include::{testDir}/browser/QuitSpec.groovy[tag=quit]
----
...
[source,groovy]
----
include::{testDir}/browser/GoogleSpec.groovy[tag=class]
----
...
[source,groovy]
----
include::{testDir}/browser/GoSpec.groovy[tag=examples,indent=0]
----
...
[source,groovy,indent=0]
----
include::{testDir}/browser/DriveSpec.groovy[tag=browser_delegates_to_page]
----
...
[source,groovy]
----
include::{testDir}/browser/PageSpec.groovy[tag=signup_page_with_content,indent=0]

include::{testDir}/browser/PageSpec.groovy[tag=using_pages_content,indent=0]
----
...
[source,groovy]
----
include::{testDir}/browser/PageSpec.groovy[tag=signup_page_with_at_checker,indent=0]

include::{testDir}/browser/PageSpec.groovy[tag=using_to,indent=0]
----
...
[source,groovy]
----
include::{testDir}/browser/ViaSpec.groovy[tag=using_via,indent=0]
----
...
[source,groovy]
----
include::{testDir}/browser/ContentDslToParameterSpec.groovy[tag=pages,indent=0]

include::{testDir}/browser/ContentDslToParameterSpec.groovy[tag=to_parameter,indent=0]
----
...
[source,groovy]
----
include::{testDir}/browser/PageChangeListenerSpec.groovy[tag=helper_classes,indent=0]

include::{testDir}/browser/PageChangeListenerSpec.groovy[tag=using_page_change_listener,indent=0]
----
...
[source,groovy]
----
include::{testDir}/browser/PageChangeListenerSpec.groovy[tag=removing_listener,indent=0]
----
...
----
include::{testDir}/browser/WithWindowSpec.groovy[tag=using_name_html]
----
...
[source,groovy,indent=0]
----
include::{testDir}/browser/WithWindowSpec.groovy[tag=using_name]
----
...
[source,html,indent=0]
----
include::{testDir}/browser/WithWindowSpec.groovy[tag=using_closure_html]
----
...
[source,groovy,indent=0]
----
include::{testDir}/browser/WithWindowSpec.groovy[tag=using_closure]
----
...
[source,html,indent=0]
----
include::{testDir}/browser/WithNewWindowSpec.groovy[tag=html]
----
...
[source,groovy,indent=0]
----
include::{testDir}/browser/WithNewWindowSpec.groovy[tag=new_window]
----
...
[source,html,indent=0]
----
include::{testDir}/browser/WithNewWindowSpec.groovy[tag=waiting_html]
----
...
----
include::{testDir}/browser/WithNewWindowSpec.groovy[tag=js]
----
...
[source,groovy,indent=0]
----
include::{testDir}/browser/WithNewWindowSpec.groovy[tag=new_window_with_wait]
----
