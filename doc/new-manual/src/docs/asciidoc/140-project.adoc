...
* github-profile:bodiam[Erik Pragt] - Migration of the manual to AsciiDoc
...
* Don't modify the predicate map passed to link:api/geb/navigator/Locator.html#find(Map%3CString,%20Object%3E,%20java.lang.String)["`Navigator.find(Map&lt;String, Object&gt;, String)`"]. [issue:339[]]
