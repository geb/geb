...
----
include::{testdir}/intro/IntroSamplesSpec.groovy[tags=dollar_examples]
----
...
[source,groovy,indent=0]
----
include::{testdir}/intro/IntroSamplesSpec.groovy[tags=refining_content]
----
...
[source,groovy]
----
include::{testdir}/intro/ScriptingSpec.groovy[tags=imports,indent=0]

include::{testdir}/intro/ScriptingSpec.groovy[tags=inline,indent=0]
----
...
[source,groovy]
----
include::{testdir}/intro/module/SelectableLinkModule.groovy[tags=imports,indent=0]
include::{testdir}/intro/page/GebHomePage.groovy[tags=imports,indent=0]

include::{testdir}/intro/module/SelectableLinkModule.groovy[tags=class,indent=0]

include::{testdir}/intro/module/HighlightsModule.groovy[tags=class,indent=0]

include::{testdir}/intro/page/GebHomePage.groovy[tags=class,indent=0]
----
...
include::{testdir}/intro/ScriptingSpec.groovy[tags=using_page_objects,indent=0]
----
...
[source,groovy]
----
include::{testdir}/intro/GebHomepageSpec.groovy[tags=imports,indent=0]

include::{testdir}/intro/GebHomepageSpec.groovy[tags=class,indent=0]
----
