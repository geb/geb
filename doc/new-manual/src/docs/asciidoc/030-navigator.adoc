...
[source,html]
----
include::{testDir}/navigator/KeystrokesSpec.groovy[tag=regular_html,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/KeystrokesSpec.groovy[tag=regular_keystrokes,indent=0]
----
