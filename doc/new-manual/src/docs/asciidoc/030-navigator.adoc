...
[source,html]
----
include::{testDir}/navigator/KeystrokesSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/KeystrokesSpec.groovy[tag=keystrokes,indent=0]
----
...
[source,html]
----
include::{testDir}/navigator/FormShortcutsSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/FormShortcutsSpec.groovy[tag=value_shortcuts,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/FormShortcutsSpec.groovy[tag=value_equivalents,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/FormShortcutsSpec.groovy[tag=element_shortcut,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/FormShortcutsSpec.groovy[tag=content_definitions,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/FormShortcutsSpec.groovy[tag=content_shortcuts,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/FormShortcutsSpec.groovy[tag=module_shortcuts,indent=0]
----
...
[source,html]
----
include::{testDir}/navigator/SelectSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/SelectSpec.groovy[tag=setting_value,indent=0]
----
...
[source,html]
----
include::{testDir}/navigator/MultiSelectSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/MultiSelectSpec.groovy[tag=setting_values,indent=0]
----
...
[source,html]
----
include::{testDir}/navigator/CheckboxSpec.groovy[tag=single_html,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/CheckboxSpec.groovy[tag=single,indent=0]
----
...
[source,html]
----
include::{testDir}/navigator/CheckboxSpec.groovy[tag=multiple_html,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/CheckboxSpec.groovy[tag=multiple,indent=0]
----
...
[source,html]
----
include::{testDir}/navigator/CheckboxSpec.groovy[tag=checked_html,indent=0]
----

[source,groovy]
----
include::{testDir}/navigator/CheckboxSpec.groovy[tag=checked,indent=0]
----
...
[source,html]
----
include::{testDir}/navigator/CheckboxSpec.groovy[tag=unchecked_html,indent=0]
----

[source,groovy]
----
include::{testDir}/navigator/CheckboxSpec.groovy[tag=unchecked,indent=0]
----
...
[source,html]
----
include::{testDir}/navigator/CheckboxSpec.groovy[tag=truth_html,indent=0]
----

[source,groovy]
----
include::{testDir}/navigator/CheckboxSpec.groovy[tag=truth,indent=0]
----
...
[source,html]
----
include::{testDir}/navigator/CheckboxSpec.groovy[tag=truth_multiple_html,indent=0]
----

[source,groovy]
----
include::{testDir}/navigator/CheckboxSpec.groovy[tag=truth_multiple,indent=0]
----
...
[source,html]
----
include::{testDir}/navigator/RadioSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/RadioSpec.groovy[tag=by_value,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/RadioSpec.groovy[tag=by_label,indent=0]
----
...
[source,html]
----
include::{testDir}/navigator/TextInputAndAreaSpec.groovy[tag=html,indent=0]
----

[source,groovy]
----
include::{testDir}/navigator/TextInputAndAreaSpec.groovy[tag=setting_value,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/TextInputAndAreaSpec.groovy[tag=typing,indent=0]
----
...
[source,html]
----
include::{testDir}/navigator/FileUploadSpec.groovy[tag=html,indent=0]
----
...
[source,groovy]
----
include::{testDir}/navigator/FileUploadSpec.groovy[tag=upload,indent=0]
----
