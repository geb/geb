...
:no-such-frame-exception-api: http://static.javadoc.io/org.seleniumhq.selenium/selenium-api/{selenium-version}/org/openqa/selenium/NoSuchFrameException.html[NoSuchFrameException]
